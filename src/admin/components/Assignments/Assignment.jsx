...
const Assignment = ({ assignment }) => {
  ...
  const [deleteAssignment, { isSuccess, isError }] =
    useDeleteAssignmentMutation();

  useEffect(() => {
    if (isError) {
      toastify.error("Something is wrong!");
    }
    if (isSuccess) {
      toastify.success("Assignment Deleted Successfully!");
    }
  }, [isSuccess, isError]);
  ...
  return (
    <tr>
      ...
      <td className="table-td">{truncateString(video_title, 50)}</td>
